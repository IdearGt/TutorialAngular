...
module.exports = "<div class=\"card\">\n  <div class=\"card-body\">\n    <form (submit)=\"addTask($event)\">\n      <div class=\"input-group\">\n        <input type=\"text\" name=\"title\" [(ngModel)]=\"title\" placeholder=\"Agregar Tarea\" class=\"form-control\">\n        <span class=\"input-group-addon\">\n          <button type=\"submit\" class=\"btn btn-primary\">\n              Add Task\n          </button>\n        </span>\n      </div>\n    </form>\n\n  </div>\n</div>\n<table class=\"table\">\n  <thead>\n    <tr>\n      <th>Estado</th>\n      <th>Titulo</th>\n      <th>Operaciones</th>\n    </tr>\n  </thead>\n  <tbody>\n      <tr *ngFor=\"let task of tasks\">\n          <td>\n            <input type=\"checkbox\" class=\"\" [checked]=\"task.isDone\" (click)=\"updateTask(task)\">\n          </td>\n          <td>{{task.title}}</td>\n          <td>\n            <button class=\"btn btn-danger\" (click)=\"deleteTask(task._id)\">\n              <i class=\"fa fa-trash\"></i>\n            </button>\n          </td>\n        </tr>\n  </tbody>\n</table>"
...
var TasksComponent = /** @class */ (function () {
    ...
    TasksComponent.prototype.deleteTask = function (id) {
        var _this = this;
        var rsp = confirm('¿Esta seguro de eliminar esta tarea?');
        if (rsp) {
